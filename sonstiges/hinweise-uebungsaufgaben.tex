...
erhält man etwa über \url{http://www.wolframalpha.com/}.
...
über die sogenannte Eindeutigkeit der Polynominterpolation verwendet werden:
\begin{quote}
Sei~$n \geq 1$. Seien~$x_1, \ldots, x_n$ paarweise verschiedene reelle Zahlen. Seien~$y_1,
...
\[ f(x_i) = y_i \]
für alle~$i = 1,\ldots,n$ gilt. Außerdem hilft es für Teilaufgabe~a), sich
