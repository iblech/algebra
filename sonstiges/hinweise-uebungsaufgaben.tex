...
\paragraph{Aufgabe 2.} Tipps werden noch folgen.
...
Kreisteilungspolynome zu berechnen. Teilaufgabe~b) kann man sehr schnell mit
Kreisteilungspolynomen oder auch etwas langsamer über das übliche Vorgehen
gelöst werden.
...
einfach durch Probieren lösen. Hier ein paar Stichworte für Teilaufgabe~b):
...
umgekehrt (wieso gilt diese Ausnahmeregel?). Wenn~$\zeta_0$ eine
