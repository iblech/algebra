...
Algorithmus verwenden. [An Def. des ggT erinnern!]
Tipp b) Eindt.: ansetzen, dann Gleichheit zeigen

\paragraph{Aufgabe 2.} Das Vorgehen für Teilaufgabe~a) ist in Beispiel~3.5 auf
Seite~75 des Skripts beschrieben. Für Teilaufgabe~b) mag die Diskriminante
hilfreich sein.
[Erwähnen, dass mit ggT jetzt meistens der normierte ggT gemeint ist.]

\paragraph{Aufgabe 4.} Mit \emph{Einspolynom} ist das konstante Polynom~$1$
gemeint.
[Nochmal an Definition der Irreduzibilität erinnern.]
