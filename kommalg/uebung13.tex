...
\item Ist~${\varprojlim\limits_n}^1 A_n = 0$?
Beschreibe~${\varprojlim\limits_n}^1 A_n$ so gut wie
möglich!
\end{enumerate}
\end{aufgabe}
...
\href{http://brownsharpie.courtneygibbons.org/?p=46}{\includegraphics[scale=1.1]{images/super-evil-problem-set}}
