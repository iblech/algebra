...
\paragraph{Aufgabe 2.} Die Gruppe~$\OOO_n(\RR)$ ist die Menge der
orthogonalen~$(n \times n)$-Matrizen. Eine Matrix~$A$ heißt genau dann
\emph{orthogonal}, wenn das Produkt~$A^t A$ die
Einheitsmatrix ist. Orthogonale Matrizen haben als Determinante stets~$\pm 1$.
Die Gruppe~$\SO_n(\RR)$ ist die Untergruppe solcher
...
vorkommenden Aufgaben der Art \emph{Geben Sie eine nicht-kommutative Gruppe der
...
\paragraph{Aufgabe 3.} In beiden Teilaufgaben geht es nicht um
...
ist per Definition ein Normalteiler~$N$, welcher selbst endlich und auflösbar
ist und folgende Eigenschaft hat: Für jeden beliebigen endlichen auflösbaren
Normalteiler~$N'$ gilt~$N' \subseteq N$.
