...
\hint{%
Zu Teilaufgabe b): Vielleicht hilft euch PrimitiIrgendwann muss man zeigen, dass das Polynom~$g(X) - h(X) Y$
als Element aus~$K(Y)[X]$ irreduzibel ist. Dazu kann man zunächst zeigen, dass
das Polynom primitiv ist, dass also der größte gemeinsame Teiler seiner 
}
