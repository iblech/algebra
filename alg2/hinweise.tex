...
im Skript zu ungenau ist, hier eine ausführlichere Definition: Als Menge ist~$R :=
\varinjlim_{i \in I} R_i$ gegeben durch
\[ R := \Bigl(\coprod_{i \in I} R_i\Bigr)/{\sim}. \]
Ein beliebiges Element von~$R$ hat also die Form
\[ [\langle i, x\rangle], \]
