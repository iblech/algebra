...
Identitätselement gemeinsam. Mit diesen Überlegungen kann man versuchen, einen
Widerspruch herzuleiten: Die Elementübersicht muss zeigen, dass es mehr
Elemente geben müsste, also faktisch in der Gruppe vorhanden sind.}

\hint{%
Hier ein Beispiel. Sei~$G$ eine Gruppe mit~$|G| = 84 = 2^2 \cdot 3 \cdot
7$ Elementen. Dan muss die Anzahl~$n_7$ der Sylowschen~$7$-Untergruppen ein
