...
\paragraph{Aufgabe 3.} In der Vorlesung ist ein Schema-F-Verfahren beschrieben,
mit dem man Teilaufgabe~c) lesen kann. Vergesst nicht, die Irreduzibilität der
gefundenen Faktoren nachzuweisen. Die Kriterien aus Aufgabe~4 könnten hilfreich sein.

\paragraph{Aufgabe 5.} Wer möchte, kann mit dieser Aufgabe mehr als~100\,\% der
Übungspunkte erreichen. Es darf verwendet werden, dass sich das Ideal
...
Teilaufgabe~b) folgt noch ein genauerer Hinweis.
% XXX
...
-- seine Elemente müssen nur auf einer offenen Umgebung um~$(a,b)$ definiert
sein.
