...
\exp(2\pi\i/10)$ ist eine primitive~$10$-te Einheitswurzel, daher muss es einen
...
nämlich eine primitive~$10$-te Einheitswurzel (siehe unten). Da~$\alpha$
(irgend-)eine~$10$-te Einheitswurzel ist, gibt es daher einen Exponent~$\ell
...
Nun müssen wir noch zu begründen, wieso~$(-\zeta)$ eine primitive~$10$-te Einheitswurzel
ist. Klar ist zumindest, dass~$(-\zeta)$ überhaupt eine~$10$-te Einheitswurzel
...
weiter relevante Zahl~$\sqrt{6}$. Aber mit~$z^1$ und~$z^3$ können wir geeignet
